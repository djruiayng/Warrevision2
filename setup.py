...
cl = LINE("mhcbwij@tmailpro.net","djry9420")
print("機器壹登入成功")
k1 = LINE("vejasif@ymail365.com","djry9420")
print("機器貳登入成功")
k2 = LINE("weqdkby@itymail.com","djry9420")
print("機器參登入成功")
k3 = LINE("ywvdxyapp@3mailapp.net","djry9420")
print("機器肆登入成功")
k4 = LINE("khbdjvrti@hide-mail.net","djry9420")
print("機器伍登入成功")
k5 = LINE("ghheuj@hide-mail.net","djry9420")
print("機器陸登入成功")
js = LINE("qwcguj@hide-mail.net","djry9420")
print("js登入成功")
js2 = LINE("jmrimzbi@hide-mail.net","djry9420")
print("js2登入成功")
print("[ 登錄系統 ]成功(  -᷄ω-᷅ )")
